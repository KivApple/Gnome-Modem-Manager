...
install:
	...
	install -Dm0644 po/gnome-modem-manager-ru_UA.mo ${LOCALE_DIR}/ru_UA/LC_MESSAGES/gnome-modem-manager.mo
uninstall:
	...
	rm -fv ${LOCALE_DIR}/ru_UA/LC_MESSAGES/gnome-modem-manager.mo
